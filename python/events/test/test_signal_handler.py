...
threads are synchronized on startup and event delivery using a ThreadSync
instance.  An exit signal handler is used to terminate all threads.
"""
    ...
    def run(self) -> None:
        ...
        try:
            ...
            with DefaultSelector() as selectors:
                selectors.register(self.event_fd, EVENT_READ)
                selectors.register(self.exit_fd, EVENT_READ)
